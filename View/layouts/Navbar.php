...
<head>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	      <link rel="stylesheet" type="text/css" href="<?= URL; ?>/web/styles/variables.css">
      <link rel="stylesheet" type="text/css" href="<?= URL; ?>/web/styles/style.css">
         <link rel="stylesheet" type="text/css" href="<?= URL; ?>/web/styles/sidebar.css">
                  <link rel="stylesheet" type="text/css" href="<?= URL; ?>/web/styles/form.css">
