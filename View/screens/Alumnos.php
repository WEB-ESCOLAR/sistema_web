...
<button type="button" class="btn_add_data" id="button_alumno"><i class="fas fa-plus-circle fa-lg"></i>Agregar Alumnos</button>
    ...
    <form  id="formulario_alumno" class="box_form" style="display: none;">
      ...
      <input  value="bruno" id="nombreEstudiante" type="text" class="input_txt_50" placeholder="Ingrese el nombre">
      </div>
      <div style="width: 50%;">
      <label class="label_group" >Apellidos del estudiante</label>
      <input value="jimenez" id="apellidoEstudiante" type="text" class="input_txt_50" placeholder="Ingrese el apellido">
      </div>
      </div>
      ...
      <input  value="juan" id="nombreApoderado" type="text" class="input_txt_50" placeholder="Ingrese el nombre">
      </div>
      <div style="width: 50%;">
      <label class="label_group" >Apellidos del Apoderado</label>
      <input  value="jimenez" id="apellidoApoderado" type="text" class="input_txt_50" placeholder="Ingrese el apellido">
      </div>
      </div>
      <div class="form-group">  
